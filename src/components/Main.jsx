                ...
                {isLoading ? (
                    ...
                    >
                        ...
                        <div className='w-screen lg:w-[75%] lg:max-h-[100vh] object-contain object-fit relative'>
                            ...
                            <div className=' text-white absolute bottom-5 text-xl 
                            left-1/2 translate-x-[-50%] 
                            md:left-1/2 md:translate-x-[-50%]
                            lg:left-10 lg:translate-x-0
                            z-10
                            '>
                            Astronomy Picture of Today</div>

                            <LazyLoadImage effect='blur' src={data?.url} alt={data?.title} className="w-screen lg:h-screen z-0" />
                        {/* </motion.div> */}
                        </div>
                        ...
                        >
                            ...
                            <p className="mt-4 lg:max-h-[60vh] lg:overflow-y-auto">{data?.message}</p>
                            
                            <button className="mt-4 bg-white text-black p-2 rounded-md hover:bg-gray-200 hover:border-none border-none"
                                onClick={downloadImage}>Download Image
                            </button>
